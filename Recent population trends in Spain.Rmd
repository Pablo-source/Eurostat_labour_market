...
- In terms of foreign population, there was a foreign population of **`r prettyNum(foreign_pop_first_year$foreign_population, big.mark=",")`** on that same initial year **`r (foreign_pop_first_year$Year)`**.
...
Next, we describe the foreign population percent share of the total population in Spain in the 2004-2025 period.
