...
In 
`r format_total_population_spain(mydataset = population_change_fmt, my_date = "2007-01-01",column = "date_fmt")`. 
...
`r format_total_population_spain(mydataset = population_change_fmt, my_date = "2018-01-01",column = "date_fmt")` 
it was
...
on 
`r format_total_population_spain(mydataset = population_change_fmt, my_date = "2022-01-01",column = "date_fmt")`
...
One year later, on
`r format_total_population_spain(mydataset = population_change_fmt, my_date = "2024-01-01",column = "date_fmt")`
it was 
...
foreign_pop_first_year <- Spain_population_nationality_fmt  %>% select (Year,foreign_population) %>% filter(Year == 2005)

foreign_pop_last_year <- Spain_population_nationality_fmt  %>% select (Year,foreign_population) %>% filter(Year == 2025)
```
