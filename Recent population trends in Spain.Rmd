...
Spain_population_nationality <- population_data_fmt %>%
...
Min_total_population <- Spain_population_nationality_fmt  %>% select (Year,total_population) %>% filter(date == min(Spain_population_nationality_fmt$date))
