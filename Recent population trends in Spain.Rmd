...
Spanish_population_plot <- Spain_population_nationality_fmt %>% 
...
Max_total_population <- Spain_population_nationality_fmt  %>% select (Year,total_population) %>% filter(Year == max(INE_calc_fields$Year))
Max_total_population


Min_total_population <- Spain_population_nationality_fmt  %>% select (Year,total_population) %>% filter(Year == min(INE_calc_fields$Year))
