...
```{r Load spanish population data, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
...
```{r read Excek into R, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
...
```{r cleansing_inpported data, message=FALSE, warning=FALSE, include=FALSE, paged.print=TRUE}
...
```
```{r creating_first_calculations, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r Spain total population bar plot, message=FALSE, warning=FALSE, include=FALSE}
options(scipen=999)
...
```{r Spain foreign population bar plot, echo=TRUE,warning=FALSE,message=FALSE,fig.width=12,fig.height=9}
options(scipen=999)

Spain_foreign_population <- INE_calc_fields %>% 
...
Spain_foreign_population

```

This last plot displays national population in Spain for the 2005-2025 period

```{r Spain national population bar plot, echo=TRUE, message=FALSE, warning=FALSE,fig.width=12,fig.height=9}
options(scipen=999)
