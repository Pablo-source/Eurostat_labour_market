...
Spain_total_population_plot <- Spain_population_nationality_fmt %>% 
                            ggplot(aes(x= date_fmt, y = total_population)) +
  geom_bar(stat = "identity", fill = "darkolivegreen2") +
  labs(title = "Spain total poulation. 2005-2025 period",
       substile = "Source: INE Spanish Office for National Statistics") +
  theme_light() +
...
forign_population_plot <- Spain_population_nationality_fmt %>% 
                            ggplot(aes(x= date_fmt, y = foreign_nationals_population)) +
...
national_population_plot <- Spain_population_nationality_fmt %>% 
                            ggplot(aes(x= date_fmt, y = Spanish_nationals)) +
...
Max_total_population <- Spain_population_nationality_fmt  %>% select (Year,total_population) %>% filter(Year == max(Spain_population_nationality_fmt$Year))
Max_total_population


Min_total_population <- Spain_population_nationality_fmt  %>% select (Year,total_population) %>% filter(Year == min(Spain_population_nationality_fmt$Year))
Min_total_population

# Foreign population figures overview
foreign_pop_first_year <- Spain_population_nationality_fmt  %>% select (Year,foreign_nationals_population) %>% filter(Year == 2005)

foreign_pop_last_year <- Spain_population_nationality_fmt  %>% select (Year,foreign_nationals_population) %>% filter(Year == 2025)
```
